...
namespace IEC61850
{
    namespace Common
    {
        ...
        public class MmsVariableSpecification : IEnumerable
        {
            ...
            private static extern void MmsVariableSpecification_destroy(IntPtr self);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern IntPtr MmsVariableSpecification_getChildValue(IntPtr self, IntPtr value,
                string childId);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern IntPtr MmsVariableSpecification_getNamedVariableRecursive(IntPtr variable,
                string nameId);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern int MmsVariableSpecification_getType(IntPtr self);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern IntPtr MmsVariableSpecification_getName(IntPtr self);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern int MmsVariableSpecification_getSize(IntPtr self);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern IntPtr MmsVariableSpecification_getChildSpecificationByIndex(IntPtr self, int index);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern IntPtr MmsVariableSpecification_getArrayElementSpecification(IntPtr self);

            [DllImport("iec61850", CallingConvention = CallingConvention.Cdecl)]
            private static extern int MmsVariableSpecification_getExponentWidth(IntPtr self);
            ...
            public MmsVariableSpecification getArrayElementType()
            {
                ...
                {
                    IntPtr varSpecPtr =
                        MmsVariableSpecification.MmsVariableSpecification_getArrayElementSpecification(self);
