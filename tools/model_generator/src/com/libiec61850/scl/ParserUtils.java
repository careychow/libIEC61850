...
public class ParserUtils {
	...
	public static Boolean parseBooleanAttribute(Node trgOpsNode, String attributeName) 
			throws SclParserException 
	{
		String valueStr = parseAttribute(trgOpsNode, attributeName);
		...
		if (valueStr.toUpperCase().equals("TRUE"))
			...
			throw new SclParserException("Illegal value for boolean attribute \"" + attributeName + "\"");
